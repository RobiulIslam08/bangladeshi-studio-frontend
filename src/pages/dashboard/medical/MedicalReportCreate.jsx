        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-6">
            ...
            <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <input type="text" name="file_no" value={form.file_no} readOnly className="w-full h-11 px-4 rounded-xl border border-slate-200 bg-slate-100 font-bold text-blue-600 outline-none cursor-not-allowed" />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="md:col-span-1">
                    ...
                    <input type="text" name="name" onChange={onChange} placeholder="Enter Name" className="w-full h-11 px-4 rounded-xl border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500/20" />
                  </div>
                  <div>
              ...
              {/* Section 3: Health & Identity */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">Blood Group</label>
                  <select name="blood_group" onChange={onChange} className="w-full h-11 px-4 rounded-xl border border-slate-200 bg-slate-50 outline-none">
                ...
                <div>
                  ...
                  <input type="date" name="date_of_birth" onChange={onChange} className="w-full h-11 px-4 rounded-xl border border-slate-200 bg-slate-50 outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-2">Passport/Iqama No</label>
                  <input type="text" name="passport_or_iqama" onChange={onChange} placeholder="Number" className="w-full h-11 px-4 rounded-xl border border-slate-200 bg-slate-50 outline-none" />
                </div>
                <div>
